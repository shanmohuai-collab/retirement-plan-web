...
export default function WritingPage() {
  ...
  async function saveEdit() {
    ...
    try {
      setSaving(true)
      const storageKey = 'writing_edits'
    ...
    <div className="space-y-6">
      ...
      {summary && (
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-sm text-muted-foreground">作品总数</CardTitle></CardHeader>
            <CardContent><p className="text-2xl font-bold">{summary.totalWorks || 0}</p></CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-sm text-muted-foreground">已投稿</CardTitle></CardHeader>
            <CardContent><p className="text-2xl font-bold text-green-600">{summary.submitted || 0}</p></CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-sm text-muted-foreground">进行中</CardTitle></CardHeader>
            <CardContent><p className="text-2xl font-bold text-blue-600">{summary.inProgress || 0}</p></CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2"><CardTitle className="text-sm text-muted-foreground">草稿</CardTitle></CardHeader>
            <CardContent><p className="text-2xl font-bold text-yellow-600">{summary.draft || 0}</p></CardContent>
          </Card>
        </div>
      )}
